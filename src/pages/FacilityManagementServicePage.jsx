// FacilityManagementServicePage.js
...
// --- List Item Component with Checkmark (for Hard/Soft services) ---
const CheckListItem = ({ text }) => (
  <motion.li
    className="flex items-start text-gray-700 py-1"
    variants={itemVariants}
  >
    <svg
...
const FacilityManagementServicePage = () => {
  ...
  const softServices = [
    ...
    'pantry',
    'gardening and landscape gardening and its maintenance',
  ];
        ...
        <div className="lg:col-span-2">
          ...
          >
            ...
            <div className="relative h-64 sm:h-80 w-full bg-gray-200 shadow-xl">
              <img
                src="https://alphaservices.in/assets/img/services/facility.jpg" // Placeholder for Facility Management image
            ...
            <div className="p-0 mt-8">
              ...
              <div className="mb-8 border-b pb-4">
                <h3 className="text-xl font-bold text-gray-800 mb-4 border-b-2 inline-block border-gray-200">
                  Hard services
                </h3>
                <ul className="space-y-1">
                  {hardServices.map((text, index) => (
...
export default FacilityManagementServicePage;