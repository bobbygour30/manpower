...
// --- Main Component ---
const SecurityEscortServicePage = () => {
  const services = [
    { name: 'Security Services', active: false },
    { name: 'Fire and Safety Services', active: false },
    { name: 'Security Escorts Services', active: true }, // ACTIVE SERVICE
  ...
  return (
    <motion.div
      ...
      animate="visible"
    >
      {/* 1. Top Header/Banner Section (Matching the consistent header design) */}
        ...
        <div className="lg:col-span-2">
          ...
          >
            ...
            <div className="relative h-64 sm:h-80 w-full bg-gray-200 shadow-xl">
              <img
                src="https://alphaservices.in/assets/img/services/escorts.jpg" // Placeholder for Security Escort image
                alt="Security Escort Service"
...
export default SecurityEscortServicePage;