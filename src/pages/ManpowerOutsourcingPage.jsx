...
const ManpowerOutsourcingPage = () => {
  const services = [
    ...
    { name: 'Manpower Outsourcing Services', active: true }, // ACTIVE SERVICE
    { name: 'House Keeping Services', active: false },
  ];
        ...
        <div className="lg:col-span-2">
          ...
          >
            ...
            <div className="relative h-64 sm:h-80 w-full bg-gray-200 shadow-xl">
              <img
                src="https://alphaservices.in/assets/img/services/manpower2.jpg" // Placeholder for Manpower Outsourcing image
                alt="Manpower Outsourcing Service"
            ...
            <div className="p-0 mt-8">
              ...
              <p className="text-gray-600 leading-relaxed">
                Manpower Outsourcing is a service where we deal with some of the aspects of the company like healthcare,
                IT, real estate, banking and finance, temporary labour, etc. for smooth functioning of the company. The
                manpower we provide for the particular outsourced job is skilled and knowledgeable in that sector.
              </p>

              {/* A simple horizontal line for separation, matching the image */}
