...
// --- Main Component ---
const FireSafetyServicePage = () => {
  const services = [
    { name: 'Security Services', active: false },
    { name: 'Fire and Safety Services', active: true },
  ...
  return (
    <motion.div
      ...
      animate="visible"
    >
      {/* 1. Top Header/Banner Section (Based on image background) */}
      <div className="relative h-48 md:h-60 overflow-hidden">
        {/* Abstract background treatment - simulating the blurry color blocks */}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-white">
          <div className="flex items-center space-x-2 text-sm font-semibold tracking-wider">
            {/* Breadcrumb style from the image */}
        ...
        <div className="lg:col-span-2">
          ...
          >
            ...
            <div className="relative h-64 sm:h-80 w-full bg-gray-200 shadow-xl">
              <img
                src="https://alphaservices.in/assets/img/services/fire_saflty.jpg" // Placeholder for Fire and Safety image
                alt="Fire and Safety Service"
            ...
            <div className="p-0 mt-8">
              ...
              {/* Checkmark list not present in the Fire Safety image, but we can add a section for consistency if needed */}
            </div>
          </motion.div>
        </div>
...
export default FireSafetyServicePage;